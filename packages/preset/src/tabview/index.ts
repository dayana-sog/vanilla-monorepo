import type { TabPanelContext, TabPanelProps } from "primevue/tabpanel"
import type { TabViewProps } from "primevue/tabview"
...
export default {
    ...
    tabpanel: {
        ...
        headerAction: ({ parent, context }: ITabPanel) => ({
            class: [
                "relative",
                ...
                // Colors and Conditions
                {
                    ...
                    "bg-surface-0 dark:bg-surface-800":
                        parent.state.d_activeIndex !== context.index,
                    "text-surface-400 dark:text-surface-0/80":
                        parent.state.d_activeIndex !== context.index,

                    // 'bg-surface-0 dark:bg-surface-800': parent.state.d_activeIndex === context.index,    ===> Verify
