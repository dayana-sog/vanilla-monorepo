...
export default {
    root: {
        class: [
            ...
            "ring-1 ring-inset ring-surface-100 dark:ring-surface-500 ring-offset-0",
        ],
    },
    legend: ({ props }: IFieldset) => ({
        class: [
            // Font
            "font-medium",
            "leading-none",
    ...
    toggler: ({ props }: IFieldset) => ({
        class: [
            ...
            // States
            {
                "hover:bg-surface-50/90 dark:hover:bg-surface-50/10":
                    props.toggleable,
            },
            {
