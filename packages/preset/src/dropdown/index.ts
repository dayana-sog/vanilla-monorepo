...
export default {
    root: ({ props, state }: IDropdownProps) => ({
        class: [
            ...
            // States
            {
                "ring-surface-200 dark:ring-surface-700": !state.focused,
    ...
    panel: {
        class: [
            ...
            "text-surface-800 dark:text-white/80",
            "ring-1 ring-surface-300 dark:ring-surface-700",
        ],
    },
    wrapper: {
        class: [
    ...
    item: ({ context }: any) => ({
        class: [
            ...
            "focus-visible:outline-none focus-visible:outline-offset-0 focus-visible:ring-2 focus-visible:focus-visible:ring-primary-500 dark:focus-visible:ring-primary-400",
    ...
    filterinput: {
        class: [
            ...
            // States
            "focus:ring-2 focus:focus:outline-none focus:outline-offset-0",
