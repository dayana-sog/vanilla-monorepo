...
export default {
    root: ({ props, context }: IButtonRoot) => ({
        class: [
            "relative",
            ...
            // Primary Button
            {
                ...
                "bg-primary-500 dark:bg-primary-400":
                    ...
                    !props.outlined &&
                    !props.plain,
                "border border-primary-600 dark:ring-primary-200":
                    !props.link &&
                    props.severity === null &&
                    !props.text &&
                    !props.outlined &&
            ...
            {
                "text-primary-500 border border-primary-600 hover:bg-primary-300/20":
            ...
            {
                "text-surface-500 dark:text-surface-400 hover:bg-surface-50":
                    props.text &&
                    props.severity === "secondary" &&
                    !props.plain,
            },
            ...
            {
                "text-surface-500 ring-1 ring-surface-100 hover:bg-surface-50 dark:ring-surface-500 dark:text-white dark:hover:ring-primary-500 dark:hover:bg-transparent":
                    props.outlined &&
                    props.severity === "secondary" &&
                    !props.plain,
            },
            ...
            // Link
            {
                "focus:border focus:border-primary-600 dark:focus:ring-primary-400":
                    props.link,
            },
    ...
    loadingicon: ({ props }: IButtonProps) => ({
        class: [
            "h-3 w-3",
            "mx-0",
            {
