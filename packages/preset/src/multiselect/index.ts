import type { MultiSelectProps, MultiSelectState } from "primevue/multiselect"
...
export default {
    root: ({ props, state }: IMultiSelectProps) => ({
        class: [
    ...
    headerCheckbox: {
        ...
        box: ({ props, context }: any) => ({
            class: [
                ...
                "text-surface-600",
                {
                    "border-surface-300 bg-surface-0 dark:border-surface-700 dark:bg-surface-950":
                        !context.checked,
                    "border-primary-500 bg-primary-500 dark:border-primary-400 dark:bg-primary-400":
                        context.checked,
                },
